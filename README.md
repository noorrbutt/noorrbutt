...
Full-stack developer based in Karachi. I build production-ready web backends, Django and FastAPI, multi-tenant architecture, REST APIs, real-time systems taking them all the way through deployment.
